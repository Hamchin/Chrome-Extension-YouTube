...
$(document).ready(() => {
    ...
    setIconButton(chatReloadAttr, chatReloadSvg);
    // チャットフィルターボタンを設置する
    ...
    setIconButton(chatFilterAttr, chatFilterSvg);
    // チャットのフィルタータイプを設定する
    const frame = getChatFrame();
